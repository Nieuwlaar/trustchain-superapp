package nl.tudelft.trustchain.eidas.ui.walletoverview
...
import nl.tudelft.trustchain.eidas.dialogs.*
import nl.tudelft.trustchain.eidas.entity.Identity
import nl.tudelft.trustchain.eidas.ui.QRScanController
import nl.tudelft.trustchain.eidas.ui.VTFragment
import nl.tudelft.trustchain.eidas.ui.contacts.ChatItem
import nl.tudelft.trustchain.eidas.ui.contacts.ChatItemRenderer
import nl.tudelft.trustchain.eidas.ui.identity.IdentityItem
import nl.tudelft.trustchain.eidas.ui.identity.IdentityItemRenderer
import nl.tudelft.trustchain.eidas.util.DividerItemDecorator
import nl.tudelft.trustchain.eidas.util.getInitials
import nl.tudelft.trustchain.eidas.util.mapToJSON
...
class WalletOverviewFragment : VTFragment(R.layout.fragment_wallet_vt) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterIdentity.registerRenderer(
            IdentityItemRenderer(
                ...
                {},
                {
                    parentActivity.selectBottomNavigationItem(eidasMainActivity.identityFragmentTag)
                }
            )
        )
        ...
        adapterContacts.registerRenderer(
            ChatItemRenderer {
                val args = Bundle().apply {
                    putString(eidasMainActivity.ARG_PUBLIC_KEY, it.publicKey.keyToBin().toHex())
                    putString(eidasMainActivity.ARG_NAME, it.name)
                    putString(eidasMainActivity.ARG_PARENT, eidasMainActivity.walletOverviewFragmentTag)
                }

                parentActivity.detailFragment(eidasMainActivity.contactChatFragmentTag, args)
            }
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvExchangeTitle.setOnClickListener {
            parentActivity.selectBottomNavigationItem(eidasMainActivity.exchangeFragmentTag)
        }
        ...
        binding.tvContactsTitle.setOnClickListener {
            parentActivity.selectBottomNavigationItem(eidasMainActivity.contactsFragmentTag)
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.actionSettings -> {
                parentActivity.detailFragment(eidasMainActivity.settingsFragmentTag, Bundle())
            }
        }
