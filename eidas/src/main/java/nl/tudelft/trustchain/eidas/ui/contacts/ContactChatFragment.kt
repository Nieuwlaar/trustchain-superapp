package nl.tudelft.trustchain.eidas.ui.contacts
...
import nl.tudelft.trustchain.eidas.databinding.FragmentContactsChatBinding
...
import nl.tudelft.trustchain.eidas.util.*
...
class ContactChatFragment : VTFragment(R.layout.fragment_contacts_chat) {
    ...
    private val publicKeyBin by lazy {
        requireArguments().getString(eidasMainActivity.ARG_PUBLIC_KEY)!!
    }

    private val name by lazy {
        requireArguments().getString(eidasMainActivity.ARG_NAME)!!
    }

    private val parentTag by lazy {
        requireArguments().getString(eidasMainActivity.ARG_PARENT)!!
    }
    ...
    private fun goToContactFragment(contact: Contact) {
        ...
        contactChatFragment.arguments = Bundle().apply {
            putString(eidasMainActivity.ARG_PUBLIC_KEY, contact.publicKey.keyToBin().toHex())
            putString(eidasMainActivity.ARG_NAME, contact.name)
            putString(eidasMainActivity.ARG_PARENT, parentTag)
        }
