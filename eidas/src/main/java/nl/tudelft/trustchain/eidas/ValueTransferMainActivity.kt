package nl.tudelft.trustchain.eidas
...
import nl.tudelft.trustchain.common.eidas.extensions.bytesToImage
import nl.tudelft.trustchain.common.eidas.extensions.decodeBytes
import nl.tudelft.trustchain.common.eidas.extensions.imageBytes
import nl.tudelft.trustchain.common.eidas.extensions.resize
...
import nl.tudelft.trustchain.eidas.dialogs.IdentityAttestationConfirmDialog
...
import nl.tudelft.trustchain.eidas.ui.contacts.ContactsFragment
import nl.tudelft.trustchain.eidas.ui.exchange.ExchangeFragment
import nl.tudelft.trustchain.eidas.ui.identity.IdentityFragment
...
import nl.tudelft.trustchain.eidas.ui.settings.SettingsFragment
import nl.tudelft.trustchain.eidas.ui.walletoverview.WalletOverviewFragment
import nl.tudelft.trustchain.eidas.util.dpToPixels
import nl.tudelft.trustchain.eidas.util.getColorIDFromThemeAttribute
...
import nl.tudelft.trustchain.eidas.ui.exchangelink.ExchangeTransferMoneyLinkFragment

class eidasMainActivity : BaseActivity() {
    override val navigationGraph = R.navigation.nav_graph_eidas
    ...
    fun reloadActivity() {
        finish()
        val intent = Intent(this, eidasMainActivity::class.java)
