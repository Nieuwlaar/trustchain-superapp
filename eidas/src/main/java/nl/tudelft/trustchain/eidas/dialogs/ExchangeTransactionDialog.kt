...
import nl.tudelft.trustchain.eidas.ui.exchange.ExchangeTransactionItem
                    ...
                    when (activeFragment.tag) {
                        eidasMainActivity.exchangeFragmentTag -> {
                            ...
                            val args = Bundle().apply {
                                putString(eidasMainActivity.ARG_PUBLIC_KEY, publicKey.keyToBin().toHex())
                                putString(eidasMainActivity.ARG_NAME, contact?.name ?: (identityName ?: resources.getString(R.string.text_unknown_contact)))
                                putString(eidasMainActivity.ARG_PARENT, eidasMainActivity.exchangeFragmentTag)
                            }
