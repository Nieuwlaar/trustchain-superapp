...
import nl.tudelft.trustchain.eidas.databinding.FragmentSettingsBinding
import nl.tudelft.trustchain.eidas.dialogs.ConfirmDialog
import nl.tudelft.trustchain.eidas.dialogs.IdentityDetailsDialog
...
class SettingsFragment : VTFragment(R.layout.fragment_settings) {
    ...
    fun onBackPressed(animated: Boolean = true) {
        val previousFragment = parentFragmentManager.fragments.filter {
            it.tag == eidasMainActivity.walletOverviewFragmentTag
        }
