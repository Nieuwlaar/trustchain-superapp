...
import nl.tudelft.trustchain.idelft2.util.md5

class AppPreferences(
    parentActivity: idelft2MainActivity
) {
    ...
    companion object {
        ...
        val APP_THEME = R.style.Theme_idelft2
        ...
        fun getInstance(parentActivity: idelft2MainActivity): AppPreferences {
