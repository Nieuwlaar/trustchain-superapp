package nl.tudelft.trustchain.idelft2.ui.walletoverview
...
import nl.tudelft.trustchain.common.idelft2.extensions.decodeImage
...
import nl.tudelft.trustchain.idelft2.databinding.FragmentWalletVtBinding
import nl.tudelft.trustchain.idelft2.dialogs.IdentityOnboardingDialog
import nl.tudelft.trustchain.idelft2.dialogs.QRCodeDialog
import nl.tudelft.trustchain.idelft2.entity.Identity
import nl.tudelft.trustchain.idelft2.ui.QRScanController
import nl.tudelft.trustchain.idelft2.ui.VTFragment
import nl.tudelft.trustchain.idelft2.ui.contacts.ChatItem
import nl.tudelft.trustchain.idelft2.ui.contacts.ChatItemRenderer
import nl.tudelft.trustchain.idelft2.ui.identity.IdentityItem
import nl.tudelft.trustchain.idelft2.ui.identity.IdentityItemRenderer
import nl.tudelft.trustchain.idelft2.util.getInitials
import nl.tudelft.trustchain.idelft2.util.mapToJSON
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterIdentity.registerRenderer(
            IdentityItemRenderer(
                ...
                {},
                {
                    parentActivity.selectBottomNavigationItem(idelft2MainActivity.identityFragmentTag)
                }
            )
        )
        ...
        adapterContacts.registerRenderer(
            ChatItemRenderer {
                val args = Bundle().apply {
                    putString(idelft2MainActivity.ARG_PUBLIC_KEY, it.publicKey.keyToBin().toHex())
                    putString(idelft2MainActivity.ARG_NAME, it.name)
                    putString(idelft2MainActivity.ARG_PARENT, idelft2MainActivity.walletOverviewFragmentTag)
                }

                parentActivity.detailFragment(idelft2MainActivity.contactChatFragmentTag, args)
            }
        )
...
//            parentActivity.selectBottomNavigationItem(idelft2MainActivity.exchangeFragmentTag)
//        }
...
//            parentActivity.selectBottomNavigationItem(idelft2MainActivity.contactsFragmentTag)
//        }
//
...
//        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.actionSettings -> {
                parentActivity.detailFragment(idelft2MainActivity.settingsFragmentTag, Bundle())
            }
        }
