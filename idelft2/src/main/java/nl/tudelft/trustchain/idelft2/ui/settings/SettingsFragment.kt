...
import nl.tudelft.trustchain.idelft2.databinding.FragmentSettingsBinding
import nl.tudelft.trustchain.idelft2.dialogs.ConfirmDialog
import nl.tudelft.trustchain.idelft2.dialogs.IdentityDetailsDialog
...
class SettingsFragment : VTFragment(R.layout.fragment_settings) {
    ...
    fun onBackPressed(animated: Boolean = true) {
        val previousFragment = parentFragmentManager.fragments.filter {
            it.tag == idelft2MainActivity.walletOverviewFragmentTag
        }
