...
import nl.tudelft.trustchain.idelft2.ui.exchange.ExchangeTransactionItem
                    ...
                    when (activeFragment.tag) {
                        idelft2MainActivity.exchangeFragmentTag -> {
                            ...
                            val args = Bundle().apply {
                                putString(idelft2MainActivity.ARG_PUBLIC_KEY, publicKey.keyToBin().toHex())
                                putString(idelft2MainActivity.ARG_NAME, contact?.name ?: (identityName ?: resources.getString(R.string.text_unknown_contact)))
                                putString(idelft2MainActivity.ARG_PARENT, idelft2MainActivity.exchangeFragmentTag)
                            }
